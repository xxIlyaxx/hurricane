...
SECRET_KEY = 'e7ac043gv2)slyc+8ykx#-u$c(8$gv!8w1cx=b%_twv#lyl)j='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    'hurricanelog.herokuapp.com',
    'localhost',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "hurricane", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "hurricane", "static")
]
